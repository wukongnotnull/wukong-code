...
## Is this a Wukong Code issue or a platform issue?
<!-- Wukong Code is a plugin. Some reported "bugs" are actually issues
     in the underlying platform or model. If you're not sure, try
     reproducing without Wukong Code installed.

     If the problem persists without Wukong Code, file the issue with
     your platform instead. -->

- [ ] I confirmed this issue does not occur without Wukong Code installed
