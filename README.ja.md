...
<p align="center">
  <img src="./assets/readme/hero.png" width="100%" alt="Wukong Code: コーディングエージェントのための完全なソフトウェア開発方法論。設計を先に、TDD、主張より検証。">
</p>
...
[Wukong Code を選ぶ理由](#wukong-code-を選ぶ理由) · [仕組み](#仕組み) · [インストール](#対応エージェントとインストール) · [基本ワークフロー](#基本ワークフロー) · [スキル](#収録内容) · [言語ガイダンス](#言語ガイダンス) · [FAQ](#faq) · [コントリビューション](#コントリビューション) · [ライセンス](#ライセンス)
