...
assert_contains skills/language-guidance/references/typescript/testing.md \
  'After TDD or testing applies, Glob of fixture **/* is forbidden until this testing.md Read completes, including after TDD SKILL.md or language-guidance SKILL.md were already Read; a workspace-root **/* that lists src or tests is a TDD failure; if TDD or testing will be used, this file must be the first file Read and you cannot retroactively switch after fixture Reads; starting process-all.test.js, process-all.test.ts, src/process-all.js, src/process-all.ts, or any fixture or src Glob, Grep, Read, or **/* workspace listing before this Read completes is a failure.'
...
assert_contains skills/test-driven-development/SKILL.md 'For source work in a supported language, load language-guidance after selecting TDD. After TDD or testing applies, Glob of fixture **/* is forbidden until testing.md Read completes, including after TDD SKILL.md or language-guidance SKILL.md were already Read; a workspace-root **/* that lists src or tests is a TDD failure; if TDD or testing will be used, testing.md must be the first file Read and you cannot retroactively switch after fixture Reads; any fixture or src Glob, Grep, Read, **/* workspace listing, npm test, plan, or no-edit conclusion before that Read completes is a failure.'
