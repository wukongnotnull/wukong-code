...
if [[ -f "$skill" ]]; then
  ...
  assert_contains "$skill" 'Inspecting fixture tests first is not a reason to delay testing.md. After TDD is selected or applicable, the first file Read must complete testing.md before any Glob including **/*, Grep, or Read of fixture src or tests; any fixture or src Glob, Grep, Read, or **/* workspace listing before that Read completes is a failure.'
...
assert_contains skills/language-guidance/references/typescript/testing.md \
  'After TDD is selected or applicable, the first file Read must complete this testing.md before any Glob including **/*, Grep, or Read of fixture src or tests; starting process-all.test.js, process-all.test.ts, src/process-all.js, src/process-all.ts, or any fixture or src Glob, Grep, Read, or **/* workspace listing before this Read completes is a failure.'
...
assert_contains skills/test-driven-development/SKILL.md 'For source work in a supported language, load language-guidance after selecting TDD. After TDD is selected or applicable, the first file Read must complete testing.md before any Glob including **/*, Grep, or Read of fixture src or tests; any fixture or src Glob, Grep, Read, **/* workspace listing, npm test, plan, or no-edit conclusion before that Read completes is a failure.'
