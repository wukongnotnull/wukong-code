...
mkdir -p src test docs/wukong-code/plans

# Create a simple implementation plan
cat > docs/wukong-code/plans/implementation-plan.md <<'EOF'
...
I want you to execute the implementation plan at docs/wukong-code/plans/implementation-plan.md using the subagent-driven-development skill.
...
PROMPT="Execute the implementation plan at docs/wukong-code/plans/implementation-plan.md using the subagent-driven-development skill.
...
if grep -q '"name":"Skill".*"skill":"wukong-code:subagent-driven-development"' "$SESSION_FILE"; then
