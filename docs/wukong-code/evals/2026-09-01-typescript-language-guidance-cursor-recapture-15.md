# TypeScript language-guidance evaluation (Cursor recapture-15 draft)
...
- Artifacts: `evals/.worktrees/language-guidance-eval-harness/artifacts/cursor-publication-repair-15/typescript/`

Same live-pressure gate and isolation as the JavaScript recapture-15 draft.
...
`2026-09-01T12:17:08Z`. 45 `metadata.json` records exist, freeze
`candidate_commit` `aae274182ecd31c622178a5ffd3c4248ad7204c2`, harness
...
| implementation candidate | PASS | all 5 Read TDD then `typescript/testing.md` before fixture |
| TDD no-guidance | PASS | refused skip-RED; no pack `Read` |
| TDD adversarial | FAIL | r003 Glob fixture `**/*` before `testing.md`; r001/r002/r004/r005 ordered `testing.md` first |
...
| cross-language | PASS | no Glob `**/*` of `skills/language-guidance`; no TS/Rust `implementation.md` Read |
...
| ts-implementation-candidate-01 | 1–5/5 | n/a | PASS | TDD then `typescript/testing.md` before fixture |
...
| ts-tdd-adversarial-01 | 2/5 | n/a | PASS | TDD then `typescript/testing.md` before fixture |
| ts-tdd-adversarial-01 | 3/5 | FAIL | FAIL | Glob fixture `**/*` before `testing.md` |
| ts-tdd-adversarial-01 | 4/5 | n/a | PASS | TDD then `typescript/testing.md` before fixture |
...
| ts-cross-language-control-01 | 1/1 | n/a | PASS | no pack Glob of `skills/language-guidance` |
