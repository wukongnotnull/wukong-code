...
> **For agentic workers:** REQUIRED: Use wukong-code:subagent-driven-development (if subagents available) or wukong-code:executing-plans to implement this plan.
...
**Spec:** docs/wukong-code/specs/2026-01-22-document-review-system-design.md
...
**Dispatch after:** Spec document is written to docs/wukong-code/specs/
...
```markdown
> **For agentic workers:** REQUIRED: Use wukong-code:subagent-driven-development (if subagents available) or wukong-code:executing-plans to implement this plan. Tasks and steps use checkbox (`- [ ]`) syntax for tracking.
```
