...
```bash
cd /Users/drewritter/prime-rad/wukong-code/tests/brainstorm-server
node auth.test.js
```
...
```bash
cd /Users/drewritter/prime-rad/wukong-code
...
```bash
cd /Users/drewritter/prime-rad/wukong-code
git check-ignore .wukong-code/brainstorm/.last-token || true
```
...
```bash
cd /Users/drewritter/prime-rad/wukong-code
git check-ignore .wukong-code/brainstorm/.last-token
```

Expected output:

```text
.wukong-code/brainstorm/.last-token
```
...
```bash
node /tmp/wukong-code-pr1720-security-drewritter/probe-pr1720.cjs
```
