...
Inspecting fixture tests first is not a reason to delay testing.md. After TDD is selected, the first Read must be testing.md; do not Glob, Grep, or Read fixture or src in the same turn; any fixture or src Glob, Grep, or Read before that Read completes is a failure.
