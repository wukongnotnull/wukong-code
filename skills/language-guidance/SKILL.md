...
Inspecting fixture tests first is not a reason to delay testing.md. Do not issue any other Read in the same turn as testing.md; wait until that Read has completed.
