...
Pi core does not ship a standard task-list tool. If a todo/task extension is installed, use its documented tool. Otherwise use Wukong Code plan files, checklists in Markdown, or a repo-local `TODO.md` for task tracking. Older Wukong Code docs may refer to `TodoWrite`; treat that as the task-tracking action above.
