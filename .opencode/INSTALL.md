...
1. Check logs: `opencode run --print-logs "hello" 2>&1 | grep -i wukong-code`
...
- Full documentation: https://github.com/wukongnotnull/wukong-code/blob/main/docs/README.opencode.md
